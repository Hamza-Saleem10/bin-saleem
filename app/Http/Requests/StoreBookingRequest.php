...
class StoreBookingRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'check_out_date.*.after'            => 'Each check-out date must be a future date.',
            'flight_code.required'              => 'The flight code field is required.',
            ...
            'flight_code.*.max'                 => 'Each flight code must not exceed 191 characters.',
            'flight_date.required'              => 'The flight date field is required.',
