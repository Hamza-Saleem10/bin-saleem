...
class UpdateBookingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            // Basic fields
            'title'                 => 'sometimes|required|in:Mr.,Mrs.',
            'customer_name'         => 'sometimes|required|string|max:191',
            'customer_email'        => 'nullable|email|max:191',
            'customer_contact_full' => 'sometimes|required|string|max:20',
            'booking_by'            => 'sometimes|required|exists:users,id',
            'adult_person'          => 'sometimes|required|integer|min:1',
            'child_person'          => 'nullable|integer|min:0',
            'infant_person'         => 'nullable|integer|min:0',
            'number_of_pax'         => 'sometimes|required|integer|min:1',
            'status'                => 'nullable|in:Pending,Confirmed,Completed,Cancelled',

            // Hotel details
            'city'                  => 'sometimes|required|array|min:1',
            'city.*'                => 'required|string|max:191',
            'hotel_name'            => 'sometimes|required|array|min:1',
            'hotel_name.*'          => 'required|string|max:255',
            'check_in_date'         => 'sometimes|required|array|min:1',
            'check_in_date.*'       => 'nullable|date|after_or_equal:today',
            'check_out_date'        => 'sometimes|required|array|min:1',
            ...
            'flight_code.*'         => 'required|string|max:50',
            ...
            // Route details
            'route_id'              => 'sometimes|required|array|min:1',
            'route_id.*'            => 'required|integer|exists:routes,id',
            'pickup_date'           => 'sometimes|required|array|min:1',
            'pickup_date.*'         => 'required|date|after_or_equal:today',
            'pickup_time'           => 'sometimes|required|array|min:1',
            'pickup_time.*'         => 'required|date_format:H:i',
            'vehicle_id'            => 'sometimes|required|array|min:1',
    ...
    public function messages(): array
    {
        return [
            ...
            'title.sometimes'                   => 'The title field is required when provided.',
            'title.required'                    => 'The title field is required.',
            'title.in'                          => 'The title must be either "Mr." or "Mrs.".',
            'customer_name.sometimes'           => 'The customer name field is required when provided.',
            ...
            'customer_contact_full.sometimes'   => 'The customer contact field is required when provided.',
            ...
            'booking_by.sometimes'              => 'The booking by field is required when provided.',
            'booking_by.required'               => 'The booking by field is required.',
            'booking_by.exists'                 => 'The selected booking by user does not exist.',
            'adult_person.sometimes'            => 'The adult person field is required when provided.',
            ...
            'number_of_pax.sometimes'           => 'The number of passengers field is required when provided.',
            ...
            'city.sometimes'                    => 'The city field is required when provided.',
            ...
            'hotel_name.sometimes'              => 'The hotel name field is required when provided.',
            ...
            'check_in_date.sometimes'           => 'The check-in date field is required when provided.',
            ...
            'check_in_date.*.after_or_equal'    => 'Each check-in date must be today or a future date.',
            'check_out_date.sometimes'          => 'The check-out date field is required when provided.',
            ...
            'pickup_date.sometimes'             => 'The pickup date field is required when provided.',
            ...
            'pickup_date.*.after_or_equal'      => 'Each pickup date must be today or a future date.',
            'pickup_time.sometimes'             => 'The pickup time field is required when provided.',
            ...
            'vehicle_id.sometimes'              => 'The vehicle ID field is required when provided.',
