<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-indigogreen">
    ...
    <div class="m-header">
        ...
        <a href="#" class="b-brand">
            ...
            <img src="{{asset('images/gb-logo.png')}}" alt="" class="logo">
                ...
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-notification">
                        ...
                        <ul class="pro-body">
                            ...
                            <li><a href="{{route('users.changePassword')}}" class="dropdown-item"><i class="feather icon-unlock"></i> Change Passowrd</a></li>
