            ...
            <div class="accordion-body">
                <div class="row g-3">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::text('from_location', null, [
                            'class' => 'form-control ' . ($errors->first('from_location', 'error') ? 'is-invalid' : ''),
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::text('to_location', null, [
                            'class' => 'form-control ' . ($errors->first('to_location', 'error') ? 'is-invalid' : ''),
