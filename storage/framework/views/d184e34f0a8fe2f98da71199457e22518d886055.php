...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Update Application']); ?>
...
<?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card card-custom gutter-b example example-compact">
                                        <!--begin::Form-->
                                        <?php echo Form::model($institution, ['route' => ['institutions.update', $institution->uuid], 'id' => 'formValidation', 'method' => 'POST', 'files' => true] ); ?>
    ...
    $('document').ready(function() {
        ...
        $('#institution_level').css('pointer-events', 'none');
    });
    </script>
    <?php $__env->stopPush(); ?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/institutions/edit.blade.php ENDPATH**/ ?>