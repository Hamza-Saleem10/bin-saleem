...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/welcomeblade.css')); ?>">
</head>
...
<div class="container">
    ...
    <header>
        <div class="header-inner">
            <div class="brand">
                <img src="<?php echo e(asset('assets/images/logo-dark.jpg')); ?>" alt="Bin Saleem Umrah Taxi Service Logo" />
    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide active">
                <img src="<?php echo e(asset('assets/images/main slider.jpg')); ?>" alt="Luxury Transfer in Makkah" />
            ...
            <div class="slide slide-2">
                <img src="<?php echo e(asset('assets/images/slider2.jpg')); ?>" alt="Premium Fleet" />
                <div class="slide-overlay">
    ...
    <section id="fleet">
        ...
        <div class="fleet-grid">
            ...
            <article class="fleet-card">
                <img src="<?php echo e(asset('assets/images/camry.jpg')); ?>" alt="Toyota Camry" />
            ...
            <!-- Innova -->
            <article class="fleet-card">
                <img src="<?php echo e(asset('assets/images/innova.jpg')); ?>" alt="Toyota Innova" />
                <div class="fleet-card-body">
                    <h3>Toyota Innova</h3>
                    <div class="fleet-meta">
            ...
            <!-- HiAce -->
            <article class="fleet-card">
                <img src="<?php echo e(asset('assets/images/hiace.jpg')); ?>" alt="Toyota HiAce" />
                <div class="fleet-card-body">
                    <h3>Toyota HiAce</h3>
                    <div class="fleet-meta">
            ...
            <!-- Staria -->
            <article class="fleet-card">
                <img src="<?php echo e(asset('assets/images/staria.jpg')); ?>" alt="Hyundai Staria" />
                <div class="fleet-card-body">
            ...
            <!-- GMC -->
            <article class="fleet-card">
                <img src="<?php echo e(asset('assets/images/gmc.jpg')); ?>" alt="GMC Yukon" />
                <div class="fleet-card-body">
                    <h3>GMC Yukon</h3>
                    <div class="fleet-meta">
                        <span class="meta-item">7 Seats</span>
    ...
    <section>
        ...
        <div class="routes-grid">
            <div class="route-card">
                <img src="<?php echo e(asset('assets/images/route1.jpg')); ?>" alt="Jeddah to Makkah" />
            ...
            <div class="route-card">
                <img src="<?php echo e(asset('assets/images/route2.jpg')); ?>" alt="Makkah to Madinah" />
            ...
            <div class="route-card">
                <img src="<?php echo e(asset('assets/images/route3.jpeg')); ?>" alt="Airport Pickup" />
...
<footer class="site-footer">
        ...
        <div class="footer-container">
            <div class="footer-section main-info">
                <div class="footer-brand">
                    <img src="<?php echo e(asset('assets/images/logo-dark.jpg')); ?>" alt="Bin Saleem Umrah Taxi Service Logo" class="footer-logo" />
            ...
            <div class="footer-section quick-links">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo e(url('/')); ?>"><i class="bi bi-house-door"></i> Home</a></li>
    ...
    <div class="footer-bottom">
        <div class="footer-container">
            <div class="copyright">
                <p>&copy; <?php echo e(date('Y')); ?> Bin Saleem Umrah Taxi Service. All Rights Reserved.</p>
...
</html><?php /**PATH D:\binslaeem\resources\views/welcome.blade.php ENDPATH**/ ?>