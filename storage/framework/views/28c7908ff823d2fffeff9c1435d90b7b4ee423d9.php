...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/intl-tel-input/css/intlTelInput.css')); ?>">
...
<!--        <div class="loader-bg">
        ...
        <script src="<?php echo e(asset('assets/intl-tel-input/js/intlTelInput.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/intl-tel-input/js/utils.js')); ?>"></script>
...
<?php /**PATH D:\binslaeem\resources\views/layouts/app.blade.php ENDPATH**/ ?>