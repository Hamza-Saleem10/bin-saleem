...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Tehsil','button' => [
                'name' => 'Add',
                'allow' => auth()
                    ->user()
                    ->can('Create Tehsil'),
                'link' => route('tehsils.create'),
            ]]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['keys' => ['Name', 'District Name', 'Status', '']]); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                ...
                const datatable_url = route('tehsils.datatable', getUrlParams(location.search));
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/levels/level-3/index.blade.php ENDPATH**/ ?>