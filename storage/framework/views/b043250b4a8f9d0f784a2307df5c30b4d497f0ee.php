...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Division','button' => [
                'name' => 'Add',
                'allow' => auth()
                    ->user()
                    ->can('Create Level1'),
                'link' => route('divisions.create'),
            ]]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['keys' => ['Name', 'Status', '']]); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                ...
                const datatable_url = route('divisions.datatable');
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/levels/level-1/index.blade.php ENDPATH**/ ?>