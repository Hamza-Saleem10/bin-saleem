...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => ''.e($role->name).' - Permissions']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card card-custom gutter-b example example-compact">
                                        <!--begin::Form-->
                                        <?php echo Form::model($role, ['method' => 'post', 'route' => ['roles.permissions',  $role->uuid]]); ?>
                                            ...
                                            <div class="card-body row">
                                                ...
                                                <?php $__currentLoopData = $permissionGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <h2 class="formsEduHeading2 mb-0 rounded-1 py-2 px-3 mb-4" style="font-size: 18px;"><?php echo e($group->name); ?></h2>
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-group">
                                                                    <div class="checkbox checkbox-fill d-inline">
                                                                        <?php echo Form::checkbox("permissions[]", $permission->name, $role->hasPermissionTo($permission->name), ["id" => "cb-".$permission->id]); ?>

                                                                        <label for="cb-<?php echo e($permission->id); ?>" class="cr"><?php echo e(ucwords($permission->name)); ?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/acl/roles/permissions.blade.php ENDPATH**/ ?>