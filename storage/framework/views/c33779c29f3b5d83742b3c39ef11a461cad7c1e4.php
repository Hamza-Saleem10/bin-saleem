...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Bookings','button' => ['name' => 'Add', 'allow' => auth()
                ->user()
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['keys' => ['Customer Name', 'Email', 'Contact No', 'Vehicle', 'Pick up ', 'Dropoff','Status','Active/In-Active','']]); ?>
...
<?php endif; ?>
<?php /**PATH D:\binslaeem\resources\views/bookings/index.blade.php ENDPATH**/ ?>