...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Districts','button' => [
                'name' => 'Add',
                'allow' => auth()->user()->can('Create Level2'),
                'link' => route('districts.create'),
            ]]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['keys' => ['Name', 'Division Name', 'Status', '']]); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                ...
                const datatable_url = route('districts.datatable');
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/levels/level-2/index.blade.php ENDPATH**/ ?>