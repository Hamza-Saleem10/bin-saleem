...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Applications','button' => [
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['keys' => ['Name', 'Tehsil', 'School Name', 'School Type', 'School Level', 'School Gender', 'Date & Time of Application','Application Status', 'Fee Status','']]); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                const datatable_url = "<?php echo e(route('institutions.datatable')); ?>";
       ...
       <script>
            function showStatusModal(institutionId) {
                ...
                $.ajax({
                    url: '<?php echo e(route("institutions.status.modal")); ?>',
                    type: 'GET',
                    data: {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/institutions/index.blade.php ENDPATH**/ ?>