...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Create Permission']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card card-custom gutter-b example example-compact">
                                        <!--begin::Form-->
                                        <?php echo Form::open(['route' => 'permissions.store', 'id' => 'formValidation']); ?>

                                            <div class="card-body row">
                                                <?php echo $__env->make('acl.permissions.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/acl/permissions/create.blade.php ENDPATH**/ ?>