...
<html>
  ...
  >
    ...
    <td style=" text-align: center; padding: 10px;">
      <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Gov Logo" style="height: 100px;">
    </td>
  ...
  <tr>
    <td colspan="5" style="text-align: center; font-size: 13px; padding: 5px;">
      ...
      <!-- Applicant Copy -->
      <?php echo $__env->make('institutions.pdf.challan-detailes', ['title' => 'APPLICANT COPY'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <?php echo $__env->make('institutions.pdf.challan-detailes', ['title' => 'DEPARTMENT COPY'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <!-- Bank Copy -->
        ...
        <?php echo $__env->make('institutions.pdf.challan-detailes', ['title' => 'BANK COPY'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/institutions/pdf/challan.blade.php ENDPATH**/ ?>