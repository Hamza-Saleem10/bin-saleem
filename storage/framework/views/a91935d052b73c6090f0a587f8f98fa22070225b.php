...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Update User']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card card-custom gutter-b example example-compact">
                                        <!--begin::Form-->
                                        <?php echo Form::model($user, ['route' => ['users.update', $user->uuid], 'id' => 'formValidation', 'method' => 'put'] ); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\pepris-gb-web\resources\views/users/edit.blade.php ENDPATH**/ ?>